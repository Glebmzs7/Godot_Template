...
def parse(text: str) -> Version:
    ...
    лучше упасть сразу и явно, чем молча продолжить с неправильно понятой версией. Старые теги
    с буквой (до отказа от статусов) сюда не относятся — их поправляют вручную на git, а не
    подгонкой парсера под них.
    """
